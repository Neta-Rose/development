...
commonness: 0..1, how likely this food is to be in an ordinary home kitchen. 1.0 staple, eaten most days: eggs, milk, butter, rice, bread, onions. 0.7 common, in most kitchens: yogurt, olive oil, canned tuna, frozen peas, bacon. 0.4 familiar, bought for a dish: parmesan, maple syrup, quinoa, sour cream. 0.2 niche, one cuisine or a specialty aisle: tahini, duck breast, plantain. 0.05 rare, exotic or institutional: turtle meat, emu, agar, commodity bulk items. Interpolate freely. Rate the food as a whole, not its rarest preparation, and ignore brand names.
